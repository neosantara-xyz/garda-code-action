"""Tests for garda/mosaico/env_bridge.py and observability.py.
...
from garda.mosaico.env_bridge import (apply_mosaico_env,
                                         langfuse_env_present)
from garda.mosaico.observability import (mosaico_log_context,
...
class TestApplyMosaicoEnv:
    ...
    def test_model_max_tokens_zero_falls_back_to_default(self, restore_settings, clear_mosaico_env, monkeypatch):
        ...
        from garda.mosaico.env_bridge import DEFAULT_CUSTOM_MODEL_MAX_TOKENS
        monkeypatch.setenv("MODEL_NAME", "my-model")
