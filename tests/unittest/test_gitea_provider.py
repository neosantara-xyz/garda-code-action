...
class TestGiteaProvider:
    @patch('garda.git_providers.gitea_provider.get_settings')
    @patch('garda.git_providers.gitea_provider.giteapy.ApiClient')
    def test_gitea_provider_auth_header(self, mock_api_client_cls, mock_get_settings):
        ...
        from garda.git_providers.gitea_provider import RepoApi
