...
shipped gpt-5.x defaults), since Garda Code Action's LiteLLMAIHandler never sends 'stop'."""
import litellm
import pytest
from starlette.testclient import TestClient

import garda.mosaico.server as server_mod
from garda.config_loader import get_settings
from garda.mosaico.executor import health_check
