...
pytestmark = pytest.mark.skipif(
    ...
    reason="external e2e tests require RUN_E2E_TESTS=true and live provider credentials",
)
...
def test_e2e_run_github_app():
    """
    What we want to do:
    (1) open a PR in a repo 'https://github.com/neosantara-xyz/garda-code-action-tests'
    ...
    repo_url = 'neosantara-xyz/garda-code-action-tests'
