...
from garda.algo import (CLAUDE_EXTENDED_THINKING_MODELS,
                           NO_SUPPORT_TEMPERATURE_MODELS,
                           STREAMING_REQUIRED_MODELS,
                           SUPPORT_REASONING_EFFORT_MODELS,
                           USER_MESSAGE_ONLY_MODELS)
from garda.algo.ai_handlers.base_ai_handler import BaseAiHandler
from garda.algo.ai_handlers.litellm_helpers import (
    MockResponse, _get_azure_ad_token, _handle_streaming_response,
    _process_litellm_extra_body)
from garda.algo.utils import ReasoningEffort, get_version
            ...
            if img_path:
                try:
                    ...
                    if r.status_code == 404:
                        error_msg = f"The image link is not [alive](img_path).\nPlease repost the original image as a comment, and send the question again with 'quote reply' (see [instructions](https://github.com/neosantara-xyz/garda-code-action/tree/main/docs/docs/tools/ask/#ask-on-images-using-the-pr-code-as-context))."
