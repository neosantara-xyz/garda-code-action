"""DiffInputProvider — a GitProvider that feeds a SUPPLIED unified diff to garda-code-action's
...
def parse_unified_diff(diff_text: str) -> List[FilePatchInfo]:
    ...
    patch = that file's section verbatim (the @@ hunk body garda-code-action's hunk processing
