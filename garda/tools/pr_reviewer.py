...
from garda.algo.utils import (ModelType, PRReviewHeader,
...
class PRReviewer:
    ...
    def auto_approve_logic(self):
        ...
        if get_settings().config.enable_auto_approval:
            ...
            self.git_provider.publish_comment("Auto-approval option for Garda Code Action is disabled. "
                                              "You can enable it via a [configuration file](https://github.com/neosantara-xyz/garda-code-action/blob/main/docs/REVIEW.md#auto-approval-1)")
