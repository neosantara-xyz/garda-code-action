...
from garda.algo import MAX_TOKENS
...
from garda.algo.pr_processing import retry_with_fallback_models
from garda.algo.token_handler import TokenHandler
from garda.algo.utils import ModelType, clip_tokens, load_yaml, get_max_tokens
from garda.config_loader import get_settings
from garda.git_providers import BitbucketServerProvider, GithubProvider, get_git_provider_with_context
...
class PRHelpMessage:
    def __init__(self, pr_url: str, args=None, ai_handler: partial[BaseAiHandler,] = DefaultAIHandler, return_as_string=False):
        ...
        try:
            if self.question_str:
                ...
                if response_str:
                    ...
                    base_path = "https://github.com/neosantara-xyz/garda-code-action/tree/main/docs/docs/"
                ...
                pr_comment = "## Garda Code Action Walkthrough 🤖\n\n"
                pr_comment += "Welcome to the Garda Code Action, an AI-powered tool for automated pull request analysis, feedback, suggestions and more."""
                pr_comment += "\n\nHere is a list of tools you can use to interact with the Garda Code Action:\n"
                base_path = "https://github.com/neosantara-xyz/garda-code-action/tree/main/docs/docs/tools"
                ...
                if isinstance(self.git_provider, GithubProvider) and not get_settings().config.get('disable_checkboxes', False):
                    ...
                    pr_comment += "</table>\n\n"
                    pr_comment += f"""\n\n(1) Note that each tool can be [triggered automatically](https://github.com/neosantara-xyz/garda-code-action/tree/main/docs/docs/usage-guide/automations_and_usage/#github-app-automatic-tools-when-a-new-pr-is-opened) when a new PR is opened, or called manually by [commenting on a PR](https://github.com/neosantara-xyz/garda-code-action/tree/main/docs/docs/usage-guide/automations_and_usage/#online-usage)."""
                    ...
                    pr_comment += "</table>\n\n"
                    pr_comment += f"""\n\nNote that each tool can be [invoked automatically](https://github.com/neosantara-xyz/garda-code-action/tree/main/docs/docs/usage-guide/automations_and_usage/) when a new PR is opened, or called manually by [commenting on a PR](https://github.com/neosantara-xyz/garda-code-action/tree/main/docs/docs/usage-guide/automations_and_usage/#online-usage)."""
