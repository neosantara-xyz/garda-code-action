...
from garda.algo.utils import ModelType, show_relevant_configurations
...
class PRUpdateChangelog:
    def __init__(self, pr_url: str, cli_mode=False, args=None, ai_handler: partial[BaseAiHandler,] = DefaultAIHandler):
