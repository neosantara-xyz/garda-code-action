...
class BitbucketServerProvider(GitProvider):
    ...
    def get_repo_settings(self):
        try:
            content = self.bitbucket_client.get_content_of_file(self.workspace_slug, self.repo_slug, ".garda.toml")
            ...
            get_logger().error(f"Failed to load .garda.toml file, error: {e}")
            return ""
