...
class GithubProvider(GitProvider):
    ...
    # Example: https://github.com/neosantara-xyz/garda-code-action.git and branch: v0.8 -> prefix: "https://github.com/neosantara-xyz/garda-code-action/blob/v0.8", suffix: ""
    ...
    def get_repo_settings(self):
        try:
            # contents = self.repo_obj.get_contents(".garda.toml", ref=self.pr.head.sha).decoded_content

            # more logical to take 'garda.toml' from the default branch
            contents = self.repo_obj.get_contents(".garda.toml").decoded_content
            return contents
        except Exception:
            return ""
        ...
        if self.deployment_type == 'app':
            ...
            try:
                ...
                raise ValueError(
                    ...
                    "https://github.com/neosantara-xyz/garda-code-action#method-2-run-from-source") from e
    ...
    def _prepare_clone_url_with_token(self, repo_url_to_clone: str) -> str | None:
        ...
        #https://github.com/neosantara-xyz/garda-code-action-pro.git
        #Need to embed inside the github token:
        #https://<token>@github.com/neosantara-xyz/garda-code-action-pro.git
