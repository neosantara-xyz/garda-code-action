...
class BitbucketProvider(GitProvider):
    ...
    def get_repo_settings(self):
        try:
            url = (f"https://api.bitbucket.org/2.0/repositories/{self.workspace_slug}/{self.repo_slug}/src/"
                   f"{self.pr.destination_branch}/.garda.toml")
    ...
    # Example: git clone git clone https://bitbucket.org/neosantara/garda-code-action.git and branch: main -> prefix: "https://bitbucket.org/neosantara/garda-code-action/src/main", suffix: ""
