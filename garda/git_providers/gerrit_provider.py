...
from garda.git_providers.local_git_provider import PullRequestMimic
...
class GerritProvider(GitProvider):
    ...
    def get_repo_settings(self):
        try:
            with open(self.repo_path / ".garda.toml", 'rb') as f:
                contents = f.read()
            return contents
        except OSError:
            return b""
    ...
    def publish_code_suggestions(self, code_suggestions: list):
        ...
        for suggestion in code_suggestions:
            ...
            path = "/".join(["neosantara", self.refspec, patch_id])
