...
from garda.algo.types import EDIT_TYPE, FilePatchInfo
...
class GitLabProvider(GitProvider):
    ...
    # Example: https://gitlab.com/neosantara/garda-code-action.git and branch: t1 -> prefix: "https://gitlab.com/neosantara/garda-code-action/-/blob/t1", suffix: "?ref_type=heads"
    ...
    def get_repo_settings(self):
        try:
            ...
            contents = self.gl.projects.get(self.id_project).files.get(file_path='.garda.toml', ref=main_branch).decode()
            return contents
        except Exception:
            return ""
    ...
    def _prepare_clone_url_with_token(self, repo_url_to_clone: str) -> str | None:
        ...
        # For example: For repo url: https://gitlab.neosantara.com/neosantara/autoscraper.git
        # Then to clone one will issue: 'git clone https://oauth2:<access token>@gitlab.neosantara.com/neosantara/autoscraper.git'
