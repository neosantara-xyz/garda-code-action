...
from garda.servers.utils import verify_signature
...
async def handle_pr_event(body: Dict[str, Any], event: str, action: str, agent: GardaAgent):
...
async def handle_comment_event(body: Dict[str, Any], event: str, action: str, agent: GardaAgent):
...
async def _perform_commands_gitea(commands_conf: str, agent: GardaAgent, body: dict, api_url: str):
