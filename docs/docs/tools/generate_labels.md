...
You can define your own custom labels in the `[custom_labels]` section. See the [custom_labels.toml](https://github.com/neosantara-xyz/garda-code-action/blob/main/garda/settings/custom_labels.toml) file for examples.
