...
Under the section `pr_update_changelog`, the [configuration file](https://github.com/neosantara-xyz/garda-code-action/blob/main/garda/settings/configuration.toml#L169) contains options to customize the 'update changelog' tool:
