...
This section provides a detailed guide on how to use Garda Code Action.
It includes information on how to adjust Garda Code Action configurations, define which tools will run automatically, and other advanced configurations.
