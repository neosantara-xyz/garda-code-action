...
Pull Requests can be very long and contain a lot of information with varying degree of relevance to the garda-code-action.
We want to be able to pack as much information as possible in a single LMM prompt, while keeping the information relevant to the garda-code-action.
